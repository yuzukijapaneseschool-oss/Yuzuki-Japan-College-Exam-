      ...
      <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center space-x-3 group py-0.5">
          <img 
            ...
            className="w-12 h-12 sm:w-13 sm:h-13 rounded-full object-contain drop-shadow-md group-hover:scale-105 transition-transform shrink-0" 
          />
          <div>
            <div className="flex items-center space-x-1.5">
              <span className="font-extrabold text-base sm:text-lg tracking-tight text-white font-japanese">

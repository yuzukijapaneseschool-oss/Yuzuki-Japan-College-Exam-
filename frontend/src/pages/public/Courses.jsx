          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0 self-start sm:self-center">
                <Link
                  to="/batch-register"
                  className="bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs px-5 py-2.5 rounded-xl shadow-md transition-all shrink-0 flex items-center space-x-1.5 active:scale-95"
                >
                  <span>Enroll in Batch 01</span>
                  <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  to="/contact"
                  className="bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs px-4 py-2.5 rounded-xl transition-all shrink-0"
                >
                  <span>Inquire</span>
                </Link>
              </div>

...
const { seedJftModelPaper13 } = require('./utils/seedJftModelPaper13');
const { seedJftModelPaper14 } = require('./utils/seedJftModelPaper14');
const { seedJftModelPaper15 } = require('./utils/seedJftModelPaper15');
const { seedJftModelPaper16 } = require('./utils/seedJftModelPaper16');
const { seedJftModelPaper17 } = require('./utils/seedJftModelPaper17');
...
const { seedJftModelPaper21 } = require('./utils/seedJftModelPaper21');
...
async function start() {
  try {
    ...
    await safeRunSeed(seedJftModelPaper13, 'seedJftModelPaper13');
    await safeRunSeed(seedJftModelPaper14, 'seedJftModelPaper14');
    await safeRunSeed(seedJftModelPaper15, 'seedJftModelPaper15');
    await safeRunSeed(seedJftModelPaper16, 'seedJftModelPaper16');
    await safeRunSeed(seedJftModelPaper17, 'seedJftModelPaper17');
    ...
    await safeRunSeed(seedJftModelPaper21, 'seedJftModelPaper21');
